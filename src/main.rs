...
impl Runtime {
    pub fn new() -> Self {
        ...
        for i in 0..4 {
            ...
            let handle = thread::Builder::new()
                ...
                .expect("Couldn't intitialize threadpool");
    ...
    pub fn run(mut self, f: impl Fn()) {
        ...
        while self.pending_events > 0 {
            ...
            // for the next timer. If there is none, we set it to infinite
            // (None)
            ...
            *epoll_timeout_lock = next_timeout;
            ...
            // ===== CHECK =====
            // an set immediate function could be added pretty easily but we won't
            // that here

            // ===== CLOSE CALLBACKS ======
            // Release resources, we won't do that here, it's just another "hook"
            // for our "extensions" to use. We release resources in every callback
            // instead.
        }
